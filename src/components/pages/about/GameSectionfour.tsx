  ...
  return (
    <main className="w-full h-auto card-section text-white pb-[50px] md:px-[80px] px-[20px] lg:pt-[60px] pt-[50px]">
      <div className="lg:flex lg:justify-between lg:items-center lg:mb-[49px]">
        <h1
          className="lg:text-[40px] text-[30px] font-bold pb-[10px] lg:pb-[0px]"
        ...
        {cardItems.map((item, index) => (
          ...
          >
            ...
            <img
              src={item.img}
              alt={item.title}
              className="h-[80px] lg:h-[auto] pt-[20px] lg:pt-[0px]"
            />
            <p className="text-center lg:text-[20px] font-bold mt-[10px]">
              {item.title}
            </p>
            <span
              className="lg:px-[8px] px-[11px] lg:pl-[16px] py-[3px] lg:py-[8px] lg:w-[126px] lg:h-[45px] offer-menu lg:text-[18px] font-medium rounded-[1000px]"
            >
              {item.offer}
            </span>
          </section>
